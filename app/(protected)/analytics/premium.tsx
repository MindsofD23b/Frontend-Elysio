...
const makeStyles = () =>
    StyleSheet.create({
        ...
        planTitle: { fontSize: 21, color: "#C3C3C3CC", fontWeight: "900" },
        ...
        priceMain: { fontSize: 25, lineHeight: 28, fontWeight: "900" },
        priceDecimals: {
            fontSize: 15,
            lineHeight: 20,
            marginBottom: 2,
        ...
        oldPrice: { fontSize: 13, opacity: 0.95, marginBottom: 15, fontWeight: "900" },
        ...
        featuresWrap: { marginTop: 14, gap: 8 },
