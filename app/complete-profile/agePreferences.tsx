...
export default function CompleteProfileAgePreferences() {
    const { gs, theme } = useTheme();
    const { data, setAgePreferences } = useCompleteProfileStore();

    const [minAge, setMinAge] = useState(String(data.minPreferredAge));
    const [maxAge, setMaxAge] = useState(String(data.maxPreferredAge));
    ...
    const onSubmit = () => {
        ...
        router.push("/complete-profile/interests");
    };
    ...
    return (
        <BackWrapper>
            ...
            <Text style={[gs.bodyText, { marginTop: 10, color: theme.base + "54" }]}>
                Set the <Text style={{ fontWeight: "bold" }}>age range</Text> you&apos;re
                open to.
            </Text>
...
const styles = StyleSheet.create({
    ...
    inputWrapper: { alignItems: "center", gap: 6 },
    ...
    dash: { fontSize: 24, marginBottom: 10 },
    error: { color: "red", fontSize: 12, textAlign: "center", marginTop: 4 },
});
