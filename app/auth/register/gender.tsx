...
export default function Gender() {
  ...
  const labelColor = (type: "male" | "female") => (selected === type ? PINK : GREY_DARK);
      ...
      <View style={styles.page}>
        ...
        <View style={styles.cardsArea}>
          ...
          >
            ...
            <Text style={[styles.cardText, { color: labelColor("male") }]}>Male</Text>
          </Pressable>
          ...
          >
            ...
            <Text style={[styles.cardText, { color: labelColor("female") }]}>Female</Text>
          </Pressable>
        </View>
