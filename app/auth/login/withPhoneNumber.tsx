        ...
        <>
            <BackWrapper>
                <View style={{ flex: 1, flexDirection: "column", width: "100%", height: "100%" }}>
                    <Text style={[gs.h1, { marginTop: 35 }]}>Login with Phone Number</Text>
                    <Text style={[gs.bodyText, { marginTop: 10, color: theme.base + "54" }]}>
                        Please enter your{" "}
                        <Text style={{ fontWeight: "bold" }}>Credentials</Text>
                    </Text>
                    <View style={{ width: "100%", marginTop: 30 }}>
                        <Input placeholder="+41 79 123 45 67" textContentType="telephoneNumber" keyboardType="phone-pad" autoComplete="tel"
                        ...
                        <Input placeholder="Password" secureTextEntry={true} textContentType="password" autoComplete="current-password" value={password} onChangeText={setPassword} />
                        {errors.password && (
                            <Text style={{ color: "red", fontSize: 12 }}>
                    ...
                    <Button style={{ marginTop: "auto", marginBottom: 30 }} onPress={() => onSubmit({ tel, password })} disabled={loading}>
